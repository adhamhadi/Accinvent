          ...
          Column(
            ...
            Center(
              ...
              TextFormField(
                ...
                textDirection: TextDirection.rtl,
                textAlign: TextAlign.start,
                decoration: ThemeHelper().textInputDecoration( ' نسبة ربح الجملة', 'ادخل نسبة ربح الجملة'),
              ),
              const SizedBox(height: 15.0,),
              TextFormField(
                controller:expireDateController,
                textDirection: TextDirection.rtl,
                textAlign: TextAlign.start,
                decoration: ThemeHelper().textInputDecoration( 'نسبة ربح المفرق', 'ادخل نسبة ربح المفرق'),
              ),
        ],
          ),
      ),
